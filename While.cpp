...
Write a program that ccontinues to asks the user to enter any number
other than 5 until the user enters the number 5. Then tell the user "Hey!
you weren't supposed to enter 5!" and exit the program.
...
second iteration "Please enter any number other than 1"m etc. etc. The program
must behave accordingly exiting when the user enters the number they were asked not to.) */
#include <iostream>
#import <ctime>
using namespace std;
...
int main() {
  double timer;
  int num=0;
  cout << "Give number (5 is not acceptable!): ";
  while (num==0) {
